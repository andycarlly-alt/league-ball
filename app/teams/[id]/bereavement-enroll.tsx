// app/teams/[id]/bereavement-enroll.tsx - COMPREHENSIVE ENROLLMENT FORM
...
export default function BereavementEnrollmentForm() {
  ...
  const [ssn, setSSN] = useState(""); // Last 4 digits only
  ...
  const [beneficiaryRelationshipOther, setBeneficiaryRelationshipOther] = useState("");
  const [beneficiaryPhone, setBeneficiaryPhone] = useState("");
  const [beneficiaryEmail, setBeneficiaryEmail] = useState("");
  const [beneficiaryPercentage, setBeneficiaryPercentage] = useState("100");

  // Secondary Beneficiary (Optional)
  const [hasSecondaryBeneficiary, setHasSecondaryBeneficiary] = useState(false);
  const [secondaryBeneficiaryFirstName, setSecondaryBeneficiaryFirstName] = useState("");
  const [secondaryBeneficiaryLastName, setSecondaryBeneficiaryLastName] = useState("");
  const [secondaryBeneficiaryRelationship, setSecondaryBeneficiaryRelationship] = useState<Relationship>("CHILD");
  const [secondaryBeneficiaryPhone, setSecondaryBeneficiaryPhone] = useState("");
  const [secondaryBeneficiaryEmail, setSecondaryBeneficiaryEmail] = useState("");
  const [secondaryBeneficiaryPercentage, setSecondaryBeneficiaryPercentage] = useState("0");
  ...
  const validateForm = () => {
    ...
    if (hasSecondaryBeneficiary) {
      const totalPercentage = parseInt(beneficiaryPercentage) + parseInt(secondaryBeneficiaryPercentage);
      if (totalPercentage !== 100) {
        Alert.alert("Invalid Percentages", "Beneficiary percentages must total 100%");
        return false;
      }
    }
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#061A2B" }}>
      ...
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 100 }}>
        ...
        {/* Continue to next message with beneficiary section... */}
        <Text style={{ color: "#9FB3C8", textAlign: "center", paddingVertical: 20 }}>
          Form continues with beneficiary information...
        </Text>
      </ScrollView>
